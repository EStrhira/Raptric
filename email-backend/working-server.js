...
app.post('/api/contact', async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      to: process.env.ADMIN_EMAIL || 'info.esthira@gmail.com',
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd;">
          ...
          <div style="padding: 30px; background: #f8f9fa;">
            ...
            <div style="background: white; padding: 15px; border-left: 4px solid #00a652; margin: 10px 0;">${message}</div>
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 RAPTRIC Email Service starting on port ${PORT}`);
