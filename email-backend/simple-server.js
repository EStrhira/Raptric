    ...
    welcome: {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 10px 10px;">
            <p>Thank you for joining the RAPTRIC family! We're excited to have you as part of our electric bike community.</p>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="https://raptric.in" style="background: #00a652; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold;">Start Shopping</a>
            </div>
            <p>Happy riding!</p>
...
async function sendEmail(to, subject, html) {
  try {
    const mailOptions = {
      from: `"RAPTRIC Electric Bikes" <${process.env.SMTP_USER}>`,
      to: to,
      subject: subject,
      html: html,
    };
