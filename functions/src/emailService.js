        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div style="text-align: center;">
              <a href="https://raptric.in" class="cta-button">Start Shopping</a>
            </div>
          ...
          <div class="footer">
            ...
            <p>You're receiving this email because you created an account on raptric.in</p>
          </div>
        </div>
      </body>
      </html>
...
async function sendEmail(to, subject, html) {
  try {
    const { data, error } = await resend.emails.send({
      from: 'RAPTRIC Electric Bikes <noreply@raptric.in>',
      to: [to],
      subject: subject,
      html: html
    });
