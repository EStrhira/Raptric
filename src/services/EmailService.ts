...
class EmailService {
  ...
  async sendContactEmail(data: ContactFormData): Promise<EmailResponse> {
    try {
      const response = await fetch(`${EMAIL_SERVICE_URL}/sendContactEmail`, {
        method: 'POST',
        headers: {
  ...
  async sendOrderConfirmationEmail(data: OrderConfirmationData): Promise<EmailResponse> {
    try {
      const response = await fetch(`${EMAIL_SERVICE_URL}/sendOrderEmail`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  async sendWelcomeEmail(data: WelcomeEmailData): Promise<EmailResponse> {
    try {
      const response = await fetch(`${EMAIL_SERVICE_URL}/sendWelcomeEmail`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
