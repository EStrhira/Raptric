...
const AddressCollection: React.FC<AddressCollectionProps> = ({ userEmail, onComplete }) => {
  ...
  useEffect(() => {
    ...
    if (existingAddresses) {
      setFormData(JSON.parse(existingAddresses))
    }
  }, [userEmail])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('AddressCollection: Saving addresses for user:', userEmail)
      console.log('AddressCollection: Address data to save:', formData)
      localStorage.setItem(`addresses_${userEmail}`, JSON.stringify(formData))
      
      // Verify it was saved
      const savedData = localStorage.getItem(`addresses_${userEmail}`)
      console.log('AddressCollection: Verification - saved data:', savedData)
    ...
    <AddressContainer>
      ...
      <AddressForm onSubmit={handleSubmit}>
          ...
          <AddressGrid>
            ...
            <FormGroup>
              ...
              <FormInput
                ...
                onChange={(e) => handleInputChange('billing', 'gstNumber', e.target.value)}
            ...
            <AddressGrid>
              <FormGroup>
                ...
                <FormInput
                  ...
                  onChange={(e) => handleInputChange('shipping', 'companyName', e.target.value)}
                  placeholder="Enter your company name (optional)"
                />
              </FormGroup>
              ...
              <FormGroup>
                ...
                <FormInput
                  type="text"
                  value={formData.shippingAddress.gstNumber}
                  onChange={(e) => handleInputChange('shipping', 'gstNumber', e.target.value)}
                  placeholder="Enter your GST number (optional)"
                />
              </FormGroup>
            </AddressGrid>
        ...
        <FormButton type="submit" disabled={isLoading}>
          {isLoading ? 'Saving Addresses...' : 'Save Addresses'}
        </FormButton>
      </AddressForm>
    </AddressContainer>
  )
