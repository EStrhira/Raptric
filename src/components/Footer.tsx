      ...
      <Container>
        <FooterContent>
          <div>
            ...
            <SocialLinks>
              <SocialLink href="https://instagram.com/rideraptric" target="_blank" rel="noopener noreferrer">
          ...
          <div>
            ...
            <FooterList>
              ...
              <FooterListItem><FooterLink to="/retailers">Our Retailers</FooterLink></FooterListItem>
              <FooterListItem><FooterLink to="/reviews">Customer Reviews</FooterLink></FooterListItem>
